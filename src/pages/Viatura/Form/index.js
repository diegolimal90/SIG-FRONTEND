...
import { TextInput, Button, Icon, Toast, CardPanel } from "react-materialize";
import { Link } from 'react-router-dom';
import ViaturaService from '../../../service/ViaturaService';
...
function Viatura({ history }) {
    ...
    async function handleSubmit(event){
        ...
        await ViaturaService.prototype.cadastrarViatura(pacote);
